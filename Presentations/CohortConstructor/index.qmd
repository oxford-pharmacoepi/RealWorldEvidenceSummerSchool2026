...
cdm$osteoarthritis <- conceptCohort(
  cdm = cdm, conceptSet = osteoarthritis, name = "osteoarthritis"
)
...
**From the initial ibuprofen base cohort, generate six independent cohorts stratified by calendar year. Each resulting cohort should be temporally constrained to capture only those exposures with occurring in the years 1975 through 1980, inclusive.**
